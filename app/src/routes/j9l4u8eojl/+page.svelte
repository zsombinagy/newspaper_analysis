...
<div class="absolute top-0 left-0 flex justify-center items-center h-full w-full">
    ...
    <div class="bg-main_blue h-30 w-30 font-playfair py-10 px-5 shadow-lg shadow-black "  >
      ...
      <div class="flex justify-center ">
        <form class="auth-from flex items-center" method="post" action="?/OAuth2">
          ...
          <button class="align-center text-white hover:text-main_yellow duration-300">Bejelentkezés</button>
        </form>
      </div>
    </div>
